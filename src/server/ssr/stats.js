...
// In TERMPoint_React it's currently not possible :(
...
export default async function () {
	...
	const AutoDLLDevOnly =
		process.env.NODE_ENV === 'development'
			? {
				vendor: {
					js: `http://${process.env.HOST}:${process.env.PORT}/vendor.js`
				},
				polyfills: {
					js: `http://${process.env.HOST}:${process.env.PORT}/polyfills.js`
				}
			}
			: {}
